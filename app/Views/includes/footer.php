    ...
    <footer class="bg-vh-theam">
                ...
                <div class="container">
                    <div class="row align-items-center row-gap-3 rounded-4 bg-vh-4 p-4 p-md-1">
                        <div class="col-lg-3 col-md-6 col-12 email-box d-flex gap-3 border-end border-start border-primary-subtle">
                            ...
                            <div class="address">
                                <div class="fs-4 fw-bolder">Email</div> 
                                <a class="fs-5 link-dark" href="mailto:info@medassure.co.in" title="Email"><span class="__cf_email__">info@medassure.co.in</span></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12 phone-box d-flex gap-3">
                            <figure class="icon rounded-circle bg-white d-flex align-items-center justify-content-center">
                                <a title="Phone" href="https://api.whatsapp.com/send?phone=+919958278202&amp;text=Hello, please contact me regarding http://www.medassure.co.in//?source=wpchat, Thank you!" target="_blank"> 
                                    <img src="<?= base_url(''); ?>assets/img/whatsaap-icon.webp" title="Phone" loading="lazy" alt="Phone" width="42" height="42"> 
                                </a> 
                            </figure>
                            <div class="address">
                                <div class="fs-4 fw-bolder">Phone</div> 
                    ...
                    <div class="row mt-3">
                        <div class="col-11 mx-auto">
                            <p class="text-light text-center"> 
                                <small>
                                    Note: Medassure Health does not provide medical
                                    advice, diagnosis or treatment. The services and information offered on
                                    www.medassure.co.in are intended solely for informational purposes and cannot replace the
                                    professional consultation or treatment by a physician. Medassure Health discourages
                                    copying, cloning of its webpages and its content and it will follow the legal
                                    procedures to protect its intellectual property.
                                </small> 
                            </p>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row text-light flex-wrap">
                        <div class="col-md-6 col-12 d-flex align-items-center center-on-mob">
                            <p class="mb-0"><small>© Copyrights <span id="year"></span> Medassure.co.in. All rights reserved.</small></p>
                        </div>
                        <div class="col-md-6 col-12 d-flex align-items-center justify-content-end center-on-mob"> 
                            <a title="DMCA" href="//www.dmca.com/Protection/Status.aspx?ID=eaa49439-f073-46e5-a1db-3e6646013a1a" title="DMCA.com Protection Status" class="dmca-badge"> 
                                <img src="https://images.dmca.com/Badges/dmca-badge-w100-5x1-01.png?ID=eaa49439-f073-46e5-a1db-3e6646013a1a" title="DMCA" alt="DMCA.com Protection Status" />
                            </a> 
                        </div>
                    </div>
                </div>
        ...
        <!-- Back to top button --> 
        <span class="btn-floating" role="button" tabindex="0" id="btn-back-to-top"> <img src="<?= base_url(''); ?>assets/img/go-to-top.webp" title="Go To Top" alt="Go To Top" width="48" height="48" loading="lazy"> </span>
    </footer>
    ...
    <div id="menu-bottom" class="bottom-menu"> 
        ...
        <a href="https://api.whatsapp.com/send?phone=919958278202&amp;text=Hello,%20please%20contact%20me%20regarding%20http://www.medassure.co.in/?source=,%20Thank%20you!" title="Whatsapp Chat" class="readmore whatsapp-color">
            <img loading="lazy" src="<?= base_url(''); ?>assets/img/whatsaap-icon.webp" alt="Chat with Us" title="Chat with Us" width="30" height="29" class="img-fluid me-1"> Chat
        </a> 
    </div>
    ...
    <script type="text/javascript" src="<?= base_url(''); ?>assets/js/multi-nav.js"></script>
    <script type="text/javascript" src="<?= base_url(''); ?>assets/js/search.js" ></script>
    <script type="text/javascript" src="<?= base_url(''); ?>assets/js/searchpage.js"></script>
    <script type="text/javascript" src="<?= base_url(''); ?>assets/js/inner-common-min.js"></script>
