                    ...
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('admin/cost'); ?>">Cost</a></li>
                                <li class="breadcrumb-item">Edit Cost</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter FAQ Title" value="<?= $cost->title; ?>" required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="country" id="country" required="">
                                                                ...
                                                                <?php foreach($countryList as $k => $v) { ?>
                                                                    <option value="<?= $v->id; ?>" <?php if($cost->country_id == $v->id){?>selected<?php } ?>><?= $v->name; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="department" id="department" required="">
                                                                ...
                                                                <?php foreach($department as $department){ ?>
                                                                    <option value="<?= $department->id; ?>" <?php if($cost->department_id == $department->id){?>selected<?php } ?>><?= $department->name; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="content" name="content" rows="22" placeholder="Enter FAQ Content" required=""><?= $cost->content; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    $('#addFaq').submit(function (e) {
        ...
        $.ajax({
            url: "<?= base_url('admin/update_cost'); ?>",
            method: "POST",
