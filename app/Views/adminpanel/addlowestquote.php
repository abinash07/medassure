                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter Author Name" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="price" id="price" placeholder="Enter Author Name" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $(document).ready(function(){
        ...
        $('#addFaq').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('admin/insert_lowest_quote'); ?>",
                    method: "POST",
