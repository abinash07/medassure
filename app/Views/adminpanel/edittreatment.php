                    ...
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('admin/treatment'); ?>">Treatment</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Department Name" value="<?= $treatment->name; ?>" required="">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="department_id" id="department_id" required="">
                                                                ...
                                                                <?php foreach($department as $k => $v) { ?>
                                                                    <option value="<?= $v->id; ?>" <?php if($treatment->department_id == $v->id){?>selected<?php } ?>><?= $v->name; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="text-left" style="margin:15px 0px;">
                                                <p id="message"></p>
                                                <input type="hidden" name="id" id="id" value="<?= $treatment->id; ?>">
...
<script>
    ...
    $('#addFaq').submit(function (e) {
        ...
        $.ajax({
            url: "<?= base_url('admin/update_treatment'); ?>",
            method: "POST",
