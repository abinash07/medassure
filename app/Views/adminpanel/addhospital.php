                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" class="form-control" name="secondaryImg" id="secondaryImg" required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="established" id="established" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="specialty" id="specialty" placeholder="Enter specialty" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="number_of_bed" id="number_of_bed" placeholder="Enter number of bed" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="team_and_specialities" name="team_and_specialities" rows="5" placeholder="Enter team and specialities" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="infrastructure" name="infrastructure" rows="5" placeholder="Enter infrastructure" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="map" id="map" placeholder="Enter map" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="location" name="location" rows="5" placeholder="Enter location" required=""></textarea>
                                                        </div>
                                                    </div>
...
<script>
    ...
    $('#addFaq').submit(function (e) {
        ...
        $.ajax({
            url: "<?= base_url('admin/insert_hospital'); ?>",
            method: "POST",
            ...
            success: function (data) {
                if(data.status == true){
                    ...
                    $('#team_and_specialities').summernote('reset');
                    $('#infrastructure').summernote('reset');
                    $('#location').summernote('reset');
