                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Author Name" value="<?= $googlerating->name; ?>" required="">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="oldProfileImg" name="oldProfileImg" style="display: none;" value="<?php echo @$googlerating->image; ?>">
                                                                    <p id="profileerrormsg"></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <?php if($googlerating->image){ ?>
                                                                    <img class="img-fluid" id="profileimagepreview" src="<?php echo base_url(); ?><?php echo @$googlerating->image; ?>" alt="User avatar" style="height: 70px; width: 70px;">
                                                                <?php }else{ ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="review" name="review" rows="10" placeholder="Enter Authors Bio" required=""><?= $googlerating->review; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="text-left" style="margin:15px 0px;">
                                                <p id="message"></p>
                                                <input type="hidden" name="id" id="id" value="<?= $googlerating->id; ?>">
    ...
    $(document).ready(function(){
        ...
        $('#addFaq').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('admin/update_google_rating'); ?>",
                    method: "POST",
