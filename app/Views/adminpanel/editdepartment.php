                    ...
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('admin/department'); ?>">Departments</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Department Name" value="<?= $department->name; ?>" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="short_name" id="short_name" placeholder="Enter Department Short Name" value="<?= $department->short_name; ?>" required="">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="country" id="country" required="">
                                                                ...
                                                                <?php foreach($countryList as $k => $v) { ?>
                                                                    <option value="<?= $v->id; ?>" <?php if($department->country_id == $v->id){?>selected<?php } ?>><?= $v->name; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
...
<script>
    ...
    $('#addFaq').submit(function (e) {
        ...
        $.ajax({
            url: "<?= base_url('admin/update_department'); ?>",
            method: "POST",
