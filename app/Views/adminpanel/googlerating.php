                    ...
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Google Rating</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div class="box box-danger with-sh">
                                <div class="box-header with-border">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h3 class="box-title pull-left">List of Google Rating </h3>
                                        </div>
                                        <div class="col-md-6" style="text-align: right;">
                                            <a href="<?= base_url('admin/addgooglerating'); ?>" class="btn btn-primary btn-sm">Add New Google Rating</a>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function(){
        var crudTable = $('#crudTable').DataTable({
            ...
            'order': [[0, 'desc']],
            'ajax': {
                'url':'<?=base_url('admin/get_all_google_rating') ?>',
                'data': function(data){
                    data.status = "1";
                }
            },
