                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter FAQ Title" value="<?= $testimonial->title; ?>" required="">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="oldProfileImg" name="oldProfileImg" style="display: none;" value="<?php echo @$testimonial->image; ?>">
                                                                    <p id="profileerrormsg"></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <?php if($testimonial->image){ ?>
                                                                    <img class="img-fluid" id="profileimagepreview" src="<?php echo base_url(); ?><?php echo $testimonial->image; ?>" alt="User avatar" style="height: 70px; width: 70px;">
                                                                <?php }else{ ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="author_id" id="author_id" required="">
                                                                ...
                                                                <?php foreach($author as $cat){ ?>
                                                                    <option value="<?= $cat->id; ?>" <?php if($testimonial->author_id == $cat->id){?>selected<?php } ?>><?= $cat->name; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="description" name="description" rows="5" placeholder="Enter FAQ Content" required=""><?= $testimonial->description; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label">Content <span class="star">*</span></label>
                                                            <textarea class="form-control" id="content" name="content" rows="22" placeholder="Enter FAQ Content" required=""><?= $testimonial->content; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    $('#addFaq').submit(function (e) {
        ...
        $.ajax({
            url: "<?= base_url('admin/update_patient_testimonial'); ?>",
            method: "POST",
