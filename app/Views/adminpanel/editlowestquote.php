                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter Author Name" value="<?= $quote->title; ?>" required="">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="oldProfileImg" name="oldProfileImg" style="display: none;" value="<?php echo @$quote->image; ?>">
                                                                    <p id="profileerrormsg"></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <?php if($quote->image){ ?>
                                                                    <img class="img-fluid" id="profileimagepreview" src="<?php echo base_url(); ?><?php echo $quote->image; ?>" alt="User avatar" style="height: 70px; width: 70px;">
                                                                <?php }else{ ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label">Price <span class="star">*</span></label>
                                                            <input type="text" class="form-control" name="price" id="price" placeholder="Enter Author Name" value="<?= $quote->price; ?>" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $(document).ready(function(){
        ...
        $('#addFaq').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('admin/update_lowest_quote'); ?>",
                    method: "POST",
