                        ...
                        <div class="col-md-12">
                            <div class="box box-danger with-sh">
                                <div class="box-header with-border">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h3 class="box-title pull-left">List of services </h3>
                                        </div>
                                        <div class="col-md-6" style="text-align: right;">
                                            <a href="<?= base_url('admin/addservice'); ?>" class="btn btn-primary btn-sm">Add New Service</a>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function(){
    var crudTable = $('#crudTable').DataTable({
        ...
        'order': [[0, 'desc']],
        'ajax': {
            'url':'<?=base_url('admin/get_all_service') ?>',
            'data': function(data){
                data.status = "1";
            }
        },
