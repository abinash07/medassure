                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="designation" id="designation" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="qualification" id="qualification" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="experience" id="experience" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="about" name="about" rows="5" placeholder="Enter About" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="monday" id="monday" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="tuesday" id="tuesday" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="wednesday" id="wednesday" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="thursday" id="thursday" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="friday" id="friday" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="saturday" id="saturday" placeholder="Enter established year" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="medical_problems" name="medical_problems" rows="5" placeholder="Enter About" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="medical_procedures" name="medical_procedures" rows="5" placeholder="Enter About" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="education_training" name="education_training" rows="5" placeholder="Enter About" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="honours_awards" name="honours_awards" rows="5" placeholder="Enter About" required=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="work_experience" name="work_experience" rows="5" placeholder="Enter About" required=""></textarea>
                                                        </div>
                                                    </div>
...
<script>
    ...
    $('#addFaq').submit(function (e) {
        ...
        $.ajax({
            url: "<?= base_url('admin/insert_doctor'); ?>",
            method: "POST",
            ...
            success: function (data) {
                if(data.status == true){
                    ...
                    $('#medical_problems').summernote('reset');
                    $('#medical_procedures').summernote('reset');
                    $('#education_training').summernote('reset');
                    $('#honours_awards').summernote('reset');
                    $('#work_experience').summernote('reset');
